...
# 15 "./I2C.h" 2
# 31 "./I2C.h"
__attribute__((inline)) void I2C_wait(void);
...
void AckI2C(void);
void I2C_stop(void) ;
void I2C_select(uint8_t address, _Bool mode);
    ...
    while(1){
        ...
        switch(Estat){
            ...
            case 2:
                ...
                z = (z0 | (z1 << 8));
                Ya = Ymostra;
                Ymostra = 0.5*y + (1-0.5)*Yant;
                Yant = Ymostra;
                Xa = Xmostra;
                Xmostra = 0.5*x + (1-0.5)*Xant;
                Xant = Xmostra;
                Za = Zmostra;
                Zmostra = 0.5*z + (1-0.5)*Zant;
                Zant = Zmostra;
            ...
            case 3:
                ...
                if((fabsf(Xmostra - xcal) >= 10) || fabsf(Ymostra - ycal) >= 10){
                    SiPuts("OBERT\n");
                    SiPuts("OBERT\n");
                    SiPuts("OBERT\n");
                    SiPuts("OBERT\n");
...
void __attribute__((picinterrupt(("")))) INTERRUPT_TMR2(void);


int valorAngle(uint8_t eix){
    int tmp;
    I2C_start();
    WriteI2C((0x1D << 1 )| 0x00);
    I2C_wait();
    WriteI2C(eix);
    I2C_repeated_start();
